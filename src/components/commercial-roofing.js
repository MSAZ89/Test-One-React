...
import './commercial-roofing.css'

const CommercialRoofing = (props) => {
  return (
    <div className={`commercial-roofing-feature-card ${props.rootClassName} `}>
      <svg viewBox="0 0 1024 1024" className="commercial-roofing-icon">
        <path
      ...
      <div className="commercial-roofing-container">
        <h2 className="commercial-roofing-text">{props.title}</h2>
...
CommercialRoofing.defaultProps = {
