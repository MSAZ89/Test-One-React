      ...
      <div className="footer-container">
        <div className="footer-logo">
          ...
          <span className="footer-text">
            <span className="">
              Your corporate leader in commercial roofing.
            </span>
            <span className="">
              <span
        ...
        <div className="footer-links-container">
          <div className="footer-container1">
            <div className="footer-product-container">
              ...
              <Link to="/services" className="footer-navlink1">
                {props.text2}
              </Link>
              ...
              <Link to="/blog" className="footer-navlink4">
                {props.text5}
              </Link>
            </div>
          </div>
...
Footer.defaultProps = {
  text7: 'Info@prestigeroofing.com',
  rootClassName: '',
  text8: '+123 (4567) 890',
  image_alt: 'logo',
  text3: 'About',
  text5: 'Blog',
  text9: 'Follow Us',
  text: '© 2022 Prestige Roofing Enterprises, All Rights Reserved.',
  text4: 'Contact',
  text1: 'Links',
  image_src: '/playground_assets/prestige-1500h.png',
  text2: 'Services',
  text6: 'Contact Us',
}
