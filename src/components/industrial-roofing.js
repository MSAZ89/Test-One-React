...
import './industrial-roofing.css'

const IndustrialRoofing = (props) => {
  return (
    <div className={`industrial-roofing-feature-card ${props.rootClassName} `}>
      <svg viewBox="0 0 1024 1024" className="industrial-roofing-icon">
        <path
      ...
      <div className="industrial-roofing-container">
        <h2 className="industrial-roofing-text">{props.title}</h2>
...
IndustrialRoofing.defaultProps = {
  description:
...
IndustrialRoofing.propTypes = {
  description: PropTypes.string,
  rootClassName: PropTypes.string,
  title: PropTypes.string,
}

export default IndustrialRoofing
