...
import './roofing-materials.css'

const RoofingMaterials = (props) => {
  return (
    <div className={`roofing-materials-feature-card ${props.rootClassName} `}>
      <svg viewBox="0 0 1024 1024" className="roofing-materials-icon">
        <path
      ...
      <div className="roofing-materials-container">
        <h2 className="roofing-materials-text">{props.title}</h2>
