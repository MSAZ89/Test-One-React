...
import './roofing-supplies.css'

const RoofingSupplies = (props) => {
  return (
    <div className={`roofing-supplies-feature-card ${props.rootClassName} `}>
      <svg viewBox="0 0 1024 1024" className="roofing-supplies-icon">
        <path
      ...
      <div className="roofing-supplies-container">
        <h2 className="roofing-supplies-text">{props.title}</h2>
...
RoofingSupplies.propTypes = {
  rootClassName: PropTypes.string,
  title: PropTypes.string,
  description: PropTypes.string,
}

export default RoofingSupplies
